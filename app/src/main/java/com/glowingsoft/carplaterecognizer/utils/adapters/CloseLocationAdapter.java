package com.glowingsoft.carplaterecognizer.utils.adapters;
...
public class CloseLocationAdapter extends RecyclerView.Adapter<CloseLocationAdapter.MyViewHolder>{
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(View itemView) {
            ...
            dropdownBtn = (ImageButton)itemView.findViewById(R.id.dropdownBtn);
        ...
        holder.dropdownBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (holder.expandCard.getVisibility()==View.GONE){
                    ...
                    holder.dropdownBtn.setBackgroundResource(R.drawable.baseline_keyboard_arrow_up_24);
                } else {
                    TransitionManager.beginDelayedTransition(holder.closeLocationCard, new AutoTransition());
                    holder.expandCard.setVisibility(View.GONE);
                    holder.dropdownBtn.setBackgroundResource(R.drawable.baseline_keyboard_arrow_down_24);
                }
            }
        });


        db.getReference().child("ParkingArea").child(id)
    ...
    public void setDatas(MyViewHolder holder, final String id, final ParkingArea parkingArea){
        ...
        TextView price2Text = (TextView) holder.expandCard.findViewById(R.id.amount2Text);
        TextView price3Text = (TextView) holder.expandCard.findViewById(R.id.amount3Text);
        TextView price4Text = (TextView) holder.expandCard.findViewById(R.id.amount4Text);
        String prepend="Ugx";
        ...
        holder.bookBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v ) {
                ...
                Intent intent=new Intent(v.getContext(), BookParkingArea.class);
        ...
        holder.mapBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v ) {
                Intent intent=new Intent(v.getContext(), GPSMap.class);
