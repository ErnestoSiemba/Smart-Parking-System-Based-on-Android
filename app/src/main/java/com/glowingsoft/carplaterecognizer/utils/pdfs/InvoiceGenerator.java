package com.glowingsoft.carplaterecognizer.utils.pdfs;
...
public class InvoiceGenerator {
    ...
    public void create(){
        ...
        canvas.drawText("GeniusPark System",30,60,paint);
        ...
        paint.setColor(Color.BLACK);
        paint.setTextAlign(Paint.Align.LEFT);
        canvas.drawText("Driver Name: ",50,320,paint);
        canvas.drawText(userObj.fullName,250,320,paint);
        canvas.drawText("Phone No: ",620,320,paint);
        paint.setTextAlign(Paint.Align.RIGHT);
        canvas.drawText(userObj.phoneNumber,canvas.getWidth()-50,320,paint);
...
//        canvas.drawText("",550,615,paint);
        paint.setTextAlign(Paint.Align.RIGHT);
        canvas.drawText("Total Cost (Ugx.):- "+String.valueOf(bookingSlot.amount),canvas.getWidth()-50,615,paint);
